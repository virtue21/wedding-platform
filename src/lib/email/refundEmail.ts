        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;">
          ...
          <tr>
            <td style="background:#ffffff;border-radius:20px;border:1px solid #fce7f3;padding:40px 36px;">
              ...
              <p style="margin:0 0 8px;font-size:13px;color:#9ca3af;letter-spacing:0.05em;text-transform:uppercase;">Refund processed</p>
              <h1 style="margin:0 0 24px;font-size:28px;font-weight:600;color:#1c1917;line-height:1.2;">
                Hi ${brideName}, your refund is complete
              </h1>

              <p style="margin:0 0 28px;font-size:15px;color:#57534e;line-height:1.6;">
                Your <strong>${planName}</strong> plan payment has been refunded in full. The plan has been deactivated
                on your account — your existing guests, registry, and other data are safe, but the features that plan
                unlocked (RSVPs, higher limits) are turned off until you subscribe again.
              </p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="background:#fff1f2;border-radius:12px;margin-bottom:28px;">
                <tr>
                  <td style="padding:20px 24px;">
                    <p style="margin:0 0 4px;font-size:12px;color:#9ca3af;text-transform:uppercase;letter-spacing:0.05em;">Amount refunded</p>
              ...
              <table cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
                <tr>
                  <td style="background:#e11d48;border-radius:12px;">
                    <a href="${appUrl}/admin/plans" style="display:inline-block;padding:14px 28px;color:#ffffff;font-size:14px;font-weight:600;text-decoration:none;">
                      View plans →
                    </a>
                  </td>
                </tr>
              ...
              <p style="margin:0;font-size:14px;color:#a8a29e;line-height:1.6;">
                If this wasn&rsquo;t expected, reply to this email or reach us at <a href="mailto:hello@nemiplanner.xyz" style="color:#e11d48;text-decoration:none;">hello@nemiplanner.xyz</a>
              </p>
